...
button_add = Button(root, text="+", padx=25,pady=20, command=display_add, bg="#FFB20F",fg="black")
button_subtract = Button(root, text="-", padx=25,pady=20, command=display_subtract, bg="#FFB20F",fg="black")
button_divide = Button(root, text="÷", padx=25,pady=20, command=display_divide, bg="#FFB20F",fg="black")
button_multiply = Button(root, text="x", padx=25,pady=20, command=display_multiply, bg="#FFB20F",fg="black")
